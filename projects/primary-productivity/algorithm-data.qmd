...
::: {.project-topbar}
  ...
  <nav class="project-tabs" aria-label="NetPP navigation">
    ...
    <a class="project-tab active" href="algorithm-data.qmd">Algorithm & Data</a>
...
Find the algorithm input data in [User Resources](user-resources.qmd#download-algorithm-input-data).
