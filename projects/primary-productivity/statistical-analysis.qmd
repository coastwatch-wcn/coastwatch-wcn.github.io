...
::: {.project-topbar}
  ...
  <nav class="project-tabs" aria-label="NetPP navigation">
    ...
    <a class="project-tab active" href="statistical-analysis.qmd">Statistical Analysis</a>
    <a class="project-tab" href="user-resources.qmd">User Resources</a>
  </nav>
...
![](images/psi_diagram.png){width="100%"}
...
![](images/greyscale_psi_timeseries.png){width=100% style="max-width: 1600px;" }
...
![](images/fig3_psi_with_centered_colorbar.png){width=70%}
...
![](images/fig5_trends_with_centered_colorbar.png){width=100%}
...
![](images/Contingency_figure.png){width=500}
...
![](images/cohens_kappa.png){width=500}
...
![](images/contingency_tables.png){width=100%}
