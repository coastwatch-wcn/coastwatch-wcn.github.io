...
<img 
  src="images/carb_delta_netpp.png"
  class="tutorial-image"
  onclick="openLightbox(this.src)"
>
...
<img 
  src="images/CCAL_3x3_contingency.png"
  class="tutorial-image"
  onclick="openLightbox(this.src)"
>
...
<a href="https://coastwatch.pfeg.noaa.gov/erddap/griddap/productivity_viirs_snpp_nrt_daily.graph" target="_blank" class="download-link">
