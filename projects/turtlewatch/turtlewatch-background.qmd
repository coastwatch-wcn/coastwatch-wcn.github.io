...
::: {.project-topbar}
  ...
  <nav class="project-tabs" aria-label="TurtleWatch navigation">
    ...
    <a class="project-tab active" href="turtlewatch-background.qmd">Background</a>
...
![Photo copyright: NOAA Fisheries](images/noaa_loggerhead_turtle.png){fig-align="left" width="50%"}
:::
...
::: {.turtlewatch-column}
![Photo copyright: NOAA Fisheries](images/drift_gillnet.png){fig-align="left" width="80%"}
:::
:::
