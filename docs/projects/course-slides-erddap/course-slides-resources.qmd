...
::: {.project-topbar}
  ...
  <nav class="project-tabs" aria-label="Secure ERDDAP Automation navigation">
    ...
    <a class="project-tab active" href="course-slides-resources.qmd">Resources</a>
  </nav>
...
[View Python Tutorial](resources/Create_PowerPoint_Satellite_Slides.ipynb){.btn-noaa}
:::
...
[View R Tutorial](resources/Create_PowerPoint_Satellite_Slides.Rmd){.btn-noaa}
:::
...
[View Project Presentation](resources/Selenium_Jan_2026_ERDDAP_Showcase.pptx.pdf){.btn-noaa}
:::
