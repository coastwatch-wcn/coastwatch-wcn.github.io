---
pagetitle: "Secure Automated ERDDAP Workflow"
...
::: {.project-topbar}
  ...
  <nav class="project-tabs" aria-label="Secure ERDDAP Automation navigation">
    <a class="project-tab is-brand" href="course-slides-erddap.qmd">Secure ERDDAP Automation</a>
    <a class="project-tab" href="course-slides-overview.qmd">Overview</a>
    <a class="project-tab active" href="course-slides-workflow.qmd">Technical Workflow</a>
...
::: {.course-slides-columns}
::: {.course-slides-column}
![](images/step-1.png){fig-align="center" width="60%" style="object-fit:contain; margin-bottom:1rem;"}
:::
...
::: {.course-slides-column}
![](images/selenium.png){fig-align="center" width="100%" style="object-fit:contain; margin-bottom:1rem;"}
...
::: {.course-slides-columns}
::: {.course-slides-column}
![](images/step-2.png){fig-align="center" width="60%" style="object-fit:contain; margin-bottom:1rem;"}
:::
...
::: {.course-slides-columns}
::: {.course-slides-column}
![](images/step-3.png){fig-align="center" width="60%" style="object-fit:contain; margin-bottom:1rem;"}
:::
...
::: {.course-slides-columns}
::: {.course-slides-column}
![](images/step-4.png){fig-align="center" width="60%" style="object-fit:contain; margin-bottom:1rem;"}
:::
...
::: {.course-slides-columns}
::: {.course-slides-column}
![](images/step-5.png){fig-align="center" width="60%" style="object-fit:contain; margin-bottom:1rem;"}
:::
...
::: {.course-slides-columns}
::: {.course-slides-column}
![](images/powerpoint.png){fig-align="center" width="100%" style="object-fit:contain; margin-bottom:1rem;"}
:::
