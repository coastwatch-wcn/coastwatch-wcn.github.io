...
::: {.project-topbar}
  ...
  <nav class="project-tabs" aria-label="TurtleWatch navigation">
    ...
    <a class="project-tab active" href="turtlewatch-data-dashboard.qmd">Data Dashboard</a>
  </nav>
...
![](data/images/indicator_placeholder.png){#bycatch-img fig-align="center" width="70%"}
